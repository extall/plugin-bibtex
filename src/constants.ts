/**
 * Global string constants used throughout the plugin
 */
export const PLUGIN_ICON = "fa fa-graduation-cap";
export const SETTINGS_SECTION_ID = "bibtex.settings";
export const SETTINGS_BIBTEX_FILE_PATH_ID = "bibtex.bibtex_file";
export const SETTINGS_CSL_FILE_PATH_ID = "bibtex.csl_file";
export const ADD_BIBTEX_REFERENCE_COMMAND = "addAttachedBibTeXReference";
